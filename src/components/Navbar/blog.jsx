...
function Blog() {
  ...
  <h2 className="text-2xl font-bold md:text-4xl md:leading-tight dark:text-[#a43579]">Latest From Our Blog</h2>
  ...
  <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6"  data-aos="fade-right"
   ...
   <Link to='/blogcontent1' className="group flex flex-col h-full border border-gray-200 hover:border-transparent hover:shadow-lg focus:outline-none focus:border-transparent focus:shadow-lg transition duration-300 rounded-xl p-5 dark:border-[#a43579] dark:hover:border-transparent dark:hover:shadow-black/40 dark:focus:border-transparent dark:focus:shadow-black/40" href="#">
      <div className="aspect-w-16 aspect-h-11">
        <img className="w-full object-cover rounded-xl" src={blog1} alt="Blog Image"/>
      </div>
      <div className="my-6">
        <h3 className="text-xl font-semibold text-gray-800 dark:text-neutral-300 dark:group-hover:text-[#a43579]">
        ...
        <Link to='/blogcontent1'  className='text-[#a43579] '>Learn more</Link>
      </div>
    ...
    <Link to='/blogcontent2' className="group flex flex-col h-full border border-gray-200 hover:border-transparent hover:shadow-lg focus:outline-none focus:border-transparent focus:shadow-lg transition duration-300 rounded-xl p-5 dark:border-[#a43579] dark:hover:border-transparent dark:hover:shadow-black/40 dark:focus:border-transparent dark:focus:shadow-black/40" href="#">
      ...
      <div className="my-6">
        ...
        <Link to='/blogcontent2' className='text-[#a43579] '>Learn more</Link>
      </div>
      <div className="mt-auto flex items-center gap-x-3">
    ...
    <Link to='/blogcontent3' className="group flex flex-col h-full border border-gray-200 hover:border-transparent hover:shadow-lg focus:outline-none focus:border-transparent focus:shadow-lg transition duration-300 rounded-xl p-5 dark:border-[#a43579] dark:hover:border-transparent dark:hover:shadow-black/40 dark:focus:border-transparent dark:focus:shadow-black/40" href="#">
      ...
      <div className="my-6">
        ...
        <Link to='/blogcontent3' className='text-[#a43579] '>Learn more</Link>
      </div>
      <div className="mt-auto flex items-center gap-x-3">
